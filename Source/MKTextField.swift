...
open class MKTextField : UITextField {
    open var padding: CGSize = CGSize(width: 5, height: 5)
    open var floatingLabelBottomMargin: CGFloat = 2.0
    open var floatingPlaceholderEnabled: Bool = false
    ...
    // floating label
    open var floatingLabelFont: UIFont = UIFont.boldSystemFont(ofSize: 10.0) {
        didSet {
            floatingLabel.font = floatingLabelFont
        }
    }
    open var floatingLabelTextColor: UIColor = UIColor.lightGray {
        didSet {
            floatingLabel.textColor = floatingLabelTextColor
        }
    }

    open var bottomBorderEnabled: Bool = true {
        didSet {
    ...
    open var bottomBorderWidth: CGFloat = 1.0
    open var bottomBorderColor: UIColor = UIColor.lightGray
    open var bottomBorderHighlightWidth: CGFloat = 1.75
